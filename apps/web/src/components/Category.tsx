  ...
  return (
    <div className="flex flex-row justify-between">
      <div className="flex justify-between">
        ...
        <div className="inline-flex items-center justify-center space-x-4 mx-2">
          <button className="">
            <AiOutlinePlusCircle
              className="w-7 h-7 "
              onClick={() => {
          ...
          <form onSubmit={deleteCategory} className="flex items-center justify-center">
            <input type="hidden" id="id" value={budget_id}></input>
            <input type="hidden" id="category" value={category_id}></input>
            <button type="submit">
              <AiTwotoneDelete className="w-7 h-7"></AiTwotoneDelete>
            </button>
          </form>
        </div>
      </div>
